                            ...
                            <tbody>
                                <?php $__currentLoopData = $barang_keluars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/detailk/<?php echo e($p->id); ?>" class="btn btn-success">preview</a>
...
<?php echo $__env->make('layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TB_inventory\resources\views/content/barang_keluar/barang_keluar.blade.php ENDPATH**/ ?>