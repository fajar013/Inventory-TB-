<?php $__env->startSection('edit_barangk'); ?>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="tgl_keluar"
                                value="<?php echo e($barang_keluars->tgl_keluar); ?>" placeholder="tgl_keluar Barang . .">
                            ...
                            <div class="selectgroup selectgroup-pills">
                                <?php $__currentLoopData = $barangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="selectgroup-item">
                                        <input type="checkbox" name="barang_id" value="<?php echo e($barang->id); ?>"
...
<?php echo $__env->make('layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TB_inventory\resources\views/form/edit_barangk.blade.php ENDPATH**/ ?>